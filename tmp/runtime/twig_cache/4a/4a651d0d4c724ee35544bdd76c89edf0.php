...
class __TwigTemplate_62c0fb821b0112d29eb8e370de3e79dd extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 20
        echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["C"] ?? null), "Html", [], "any", false, false, true, 20), "hiddenField", [("java" . $this->sandbox->ensureToStringAllowed(($context["name"] ?? null), 20, $this->source)), ($context["value"] ?? null), ["id" => ("java" . $this->sandbox->ensureToStringAllowed(        // line 21
...
";
    ...
    {
        return new Source("", "/survey/questions/answer/listradio/answer.twig", "C:\\laragon\\www\\najm\\limesurvey\\application\\views\\survey\\questions\\answer\\listradio\\answer.twig");
    }
