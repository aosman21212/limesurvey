...
class __TwigTemplate_be876b0a6f1f6351a4b7941df734b2d1 extends Template
{
    private $source;
    private $macros = [];
...
($context["C"] ?? null), "Html", [], "any", false, false, true, 34), "dropDownList", ["lang", twig_get_attribute($this->env, $this->source,             // line 36
($context["aLCD"] ?? null), "sSelected", [], "any", false, false, true, 36), twig_get_attribute($this->env, $this->source,             // line 37
...
";
    ...
    {
        return new Source("", "./subviews/navigation/language_changer.twig", "C:\\laragon\\www\\najm\\limesurvey\\themes\\survey\\vanilla\\views\\subviews\\navigation\\language_changer.twig");
    }
