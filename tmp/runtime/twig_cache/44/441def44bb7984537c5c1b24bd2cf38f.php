...
/* __string_template__eed4ce0e94fdab6f943facc7c4a81ccc */
class __TwigTemplate_3b127b6e771fd9e561070ff3788fc80b extends Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"answeroptions-table-wrapper\" style=\"max-height: 394px;\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["answerOption"]) {
                    ...
                    echo "                            <!-- Line tag -->
                            ";
                    // line 61
                    $this->loadTemplate("answerOptionRow.twig", "__string_template__eed4ce0e94fdab6f943facc7c4a81ccc", 61)->display(twig_array_merge($context, ["activated" =>                     // line 62
...
";
        ...
        if ((($context["first"] ?? null) == false)) {
            ...
            // line 121
            echo "    ";
            $this->loadTemplate("modals.twig", "__string_template__eed4ce0e94fdab6f943facc7c4a81ccc", 121)->display($context);
        }
        // line 123
        echo "
<!-- For javascript -->
...
";
    ...
    {
        return "__string_template__eed4ce0e94fdab6f943facc7c4a81ccc";
    }
    ...
    {
        return new Source("", "__string_template__eed4ce0e94fdab6f943facc7c4a81ccc", "");
    }
