...
class __TwigTemplate_e9f08179e8c5e85b7a5efc7d5c17358c extends Template
{
    private $source;
    private $macros = [];
...
($context["assessmentvisible"] ?? null)) {
    ...
    <td  class=\"answeroption-text\" style=\"vertical-align: middle;\">
        ...
        echo "\"
            ...
            ";
        // line 118
        echo getEditor("editanswer", (((((("answeroptions[" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 120
($context["answerOption"] ?? null), "aid", [], "any", false, false, true, 120), 120, $this->source)) . "][") . $this->sandbox->ensureToStringAllowed(($context["scale_id"] ?? null), 120, $this->source)) . "][answeroptionl10n][") . $this->sandbox->ensureToStringAllowed(($context["language"] ?? null), 120, $this->source)) . "]"), (((("[" . gT("Answer option:", "js")) . "](") . $this->sandbox->ensureToStringAllowed(        // line 121
...
($context["question"] ?? null), "sid", [], "any", false, false, true, 122), 122, $this->source), $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 123
($context["question"] ?? null), "gid", [], "any", false, false, true, 123), 123, $this->source), $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 124
($context["question"] ?? null), "qid", [], "any", false, false, true, 124), 124, $this->source), "editanswer");
        // line 126
        echo "
        </div>
    </td>
    ...
    <td style=\"vertical-align: middle; white-space: nowrap;\" class=\"answeroption-actions\">
        ...
        if (($context["first"] ?? null)) {
            ...
            // line 136
            echo $this->sandbox->ensureToStringAllowed(($context["assessmentvisible"] ?? null), 136, $this->source);
            echo "'
                    data-position=\"";
            // line 137
            echo $this->sandbox->ensureToStringAllowed(($context["position"] ?? null), 137, $this->source);
            echo "\"
                    data-code=\"";
            // line 138
            echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["answerOption"] ?? null), "code", [], "any", false, false, true, 138), 138, $this->source);
            echo "\"
                    data-scale-id=\"";
            // line 139
...
";
    ...
    {
        return array (  318 => 149,  312 => 146,  305 => 142,  299 => 139,  295 => 138,  291 => 137,  287 => 136,  282 => 133,  280 => 132,  272 => 126,  270 => 124,  269 => 123,  268 => 122,  267 => 121,  266 => 120,  265 => 118,  260 => 116,  256 => 115,  252 => 114,  244 => 113,  236 => 112,  226 => 104,  222 => 102,  216 => 99,  213 => 98,  211 => 97,  202 => 91,  196 => 90,  190 => 89,  184 => 85,  182 => 84,  173 => 78,  167 => 77,  161 => 76,  155 => 72,  153 => 71,  149 => 69,  144 => 67,  139 => 64,  136 => 63,  127 => 56,  120 => 54,  114 => 53,  108 => 49,  102 => 46,  96 => 45,  90 => 44,  85 => 41,  83 => 40,  73 => 33,  63 => 25,  60 => 24,  52 => 20,  44 => 19,  39 => 16,);
    }

    public function getSourceContext()
    {
        return new Source("", "answerOptionRow.twig", "C:\\laragon\\www\\najm\\limesurvey\\application\\views\\questionAdministration\\answerOptionRow.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("gT" => 33, "getLanguageRTL" => 115, "getEditor" => 118);
